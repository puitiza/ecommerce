...
public interface ProductOpenApi extends CrudOpenApi<ProductDto, Long> {
    ...
    @Override
    @Operation(summary = "Retrieve All Products", description = "Retrieves all products",
            security = @SecurityRequirement(name = "security_auth"))
    @ApiErrorResponses
    ...
    @Override
    @Operation(summary = "Retrieve Product by ID", description = "Retrieves a product by its ID",
            security = @SecurityRequirement(name = "security_auth"))
    @ApiErrorResponses
